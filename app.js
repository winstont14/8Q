...
for (var i = 0; i < questions.length; i++) {
  ...
  if (question !== "yes" && question !== "no") {
    ...
    if (score == 0 ) {
      swal("ไม่มีแนวโน้มเสี่ยงที่จะฆ่าตัวตาย","แปลผลสำเร็จ","success");
    } 
    else if (score <= 8)
    {
      swal("มีแนวโน้มเสี่ยงที่จะฆ่าตัวตายในปัจจุบัน   ระดับน้อย","แปลผลสำเร็จ","success");
    }
    else if(score <=17 )
    {
      swal("มีแนวโน้มเสี่ยงที่จะฆ่าตัวตายในปัจจุบัน   ระดับปานกลาง","แปลผลสำเร็จ","success");
    }

    else {
      swal("มีแนวโน้มเสี่ยงที่จะฆ่าตัวตายในปัจจุบัน ระดับรุนแรง","ต้องพบแพทย์เพื่อประเมินอาการและให้การรักษาโดยเร็ว ไม่ควรปล่อยทิ้งไว้","success");
